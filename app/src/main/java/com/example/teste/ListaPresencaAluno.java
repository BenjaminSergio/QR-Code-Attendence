...
public class ListaPresencaAluno extends AppCompatActivity {
        ...
        if(local.equals("")){
            ...
            first.addSnapshotListener(new EventListener<QuerySnapshot>() {
                ...
                public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                    ...
                    ArrayAdapter<String> teste1 = new ArrayAdapter<String>(ListaPresencaAluno.this, android.R.layout.simple_list_item_1,teste);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_presenca_aluno);
        pesquisa=findViewById(R.id.editPalavraAluno);
        busca=findViewById(R.id.Buscar);
        lista = (ListView) findViewById(R.id.listVPesquisaAluno);
